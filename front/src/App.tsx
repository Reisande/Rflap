...
import { AutomataContext } from './components/AutomataContext';
...
function App() {
  ...
  function add_nodel(e: any, data: any) {
    // console.log(e,data);
  }
  function change_node_name(e: any) {
    // console.log("E"+ e.target.value);
  }

  function handleClickl(e: any, data: any) {
